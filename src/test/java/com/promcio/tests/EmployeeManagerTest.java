...
public class EmployeeManagerTest {
	  ...
	  * Employee
	  */
	 private static final String[] NAMES = { "Jan", "Michal", "George" };
	 ...
	 public void testAddEmployment() {
			// EmployeeManager.addEmployment(CON_START_1, CON_END_1, CON_TYPE_1,
			// SALARY_1, HOURS_1);
			// assert EmployeeManager.getStatus();
	 }
	 ...
	 public void testAddEmployeeDetails() {
			// EmployeeManager.addEmployeeDetails(CITY_1, POSTCODE_1, STREET_1,
			// BUILDING_NR_1, APARTMENT_NR_1, STAIRCASE_NR_1, PHONE_NR_1, EMAIL_1);
			// assert EmployeeManager.getStatus();
	 }
