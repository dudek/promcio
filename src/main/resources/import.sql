...
insert into employment (id, contracttype, period, hoursnorm, contractvalue, hoursalary, employee_id, startdate_id, enddate_id) values (1, 'Zlecenie', 3, 480, 10000.0, 0, 7, 3, 4)
insert into employment (id, contracttype, period, hoursnorm, contractvalue, hoursalary, employee_id, startdate_id, enddate_id) values (2, 'Zlecenie', 3, 480, 12000.0, 0, 8, 5, 6)
insert into employment (id, contracttype, period, hoursnorm, contractvalue, hoursalary, employee_id, startdate_id, enddate_id) values (3, 'Zlecenie', 3, 240, 20000.0, 0, 9, 5, 6)
insert into employment (id, contracttype, period, hoursnorm, contractvalue, hoursalary, employee_id, startdate_id, enddate_id) values (4, 'Oprace', 1, 160, 0.0, 8, 1, 3, 4)
insert into employment (id, contracttype, period, hoursnorm, contractvalue, hoursalary, employee_id, startdate_id, enddate_id) values (5, 'Oprace', 1, 160, 0.0, 8, 2, 3, 4)
insert into employment (id, contracttype, period, hoursnorm, contractvalue, hoursalary, employee_id, startdate_id, enddate_id) values (6, 'Oprace', 1, 160, 0.0, 8, 3, 3, 4)
insert into employment (id, contracttype, period, hoursnorm, contractvalue, hoursalary, employee_id, startdate_id, enddate_id) values (7, 'Oprace', 1, 80, 0.0, 10, 4, 3, 4)
insert into employment (id, contracttype, period, hoursnorm, contractvalue, hoursalary, employee_id, startdate_id, enddate_id) values (8, 'Oprace', 1, 80, 0.0, 10, 5, 5, 6)
insert into employment (id, contracttype, period, hoursnorm, contractvalue, hoursalary, employee_id, startdate_id, enddate_id) values (9, 'Oprace', 1, 80, 0.0, 12, 6, 5, 6)
